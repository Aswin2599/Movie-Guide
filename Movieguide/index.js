...
$(document).ready(function () {
	...
	var settings = {
		...
		headers: {
			...
			'x-rapidapi-key': 'b5759b38bcmshb0993042849a708p18b90bjsn24c583d215b7'
		}
	};
	...
	$('#search-button').click(function () {
		...
		// Redirect to results.html with the user input as a query parameter
		window.location.href = 'results.html?query=' + userInput;
	}); 
